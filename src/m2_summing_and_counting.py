...
def run_test_sum_more_cosines():
    ...
    print('Test 2 expected:','(approximately)')
    print('       actual:',answer)

    # Test 3:
    expected = 0.1315
    answer = sum_more_cosines(4,5)
    print('Test 3 expected:','(approximately)')
    print('       actual:',answer)
...
def count_sines_from(m, n):
    ...
    Since:  sine(3) is about 0.14
            ...
            sine(7) is about 0.99
            sine(9)is about 0.66
            sine(8) is about 0.41
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 2:
    expected = 200
    answer = count_sines_vs_cosines(99)
    print('Test 2 expected:', expected)
    print('       actual:', answer)

    # Test 3:
    expected = 300
    answer = count_sines_vs_cosines(98)
    print('Test 3 expected:', expected)
    print('       actual:', answer)
    ...
    # Test 5:
    expected = 500
    answer = count_sines_vs_cosines(96)
    print('Test 5 expected:', expected)
    print('       actual:', answer)

    # Test 6:
    expected = 600
    answer = count_sines_vs_cosines(95)
    print('Test 6 expected:',expected)
    print('      actual:',answer)
